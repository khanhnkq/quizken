...
const HomeHero = () => {
        ...
        switch (theme) {
            ...
            case 'theme_neon_night':
             ...
             case 'theme_pastel_dream':
                return {
                    active: true,
                    mascot: PastelHeartIcon, // Conceptual
    ...
    return (
        <section ref={heroRef} className="relative min-h-[90vh] md:min-h-screen pt-24 pb-12 overflow-hidden flex items-center bg-background">
            ...
            <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] bg-primary/20 rounded-full mix-blend-screen filter blur-[80px] opacity-40 animate-blob" />
            <div className="absolute top-[20%] left-[-10%] w-[600px] h-[600px] bg-secondary/20 rounded-full mix-blend-screen filter blur-[80px] opacity-40 animate-blob animation-delay-2000" />
            <div className="absolute bottom-[-10%] right-[20%] w-[600px] h-[600px] bg-accent/20 rounded-full mix-blend-screen filter blur-[80px] opacity-40 animate-blob animation-delay-4000" />
                    ...
                    <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
                        ...
                        <div className="hero-buttons flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2 opacity-0">
                            ...
                            <Button
                                variant="outline"
                                size="xl"
                                className="w-full sm:w-auto text-lg px-8 py-7 rounded-[2rem] border-2 border-border hover:border-primary/50 hover:bg-card text-foreground hover:text-primary font-bold"

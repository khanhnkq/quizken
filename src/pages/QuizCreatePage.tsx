...
const QuizCreatePage = () => {
  ...
  return (
    <div className="h-screen bg-slate-50 flex flex-col relative overflow-hidden">
      ...
      {/* Header - Sticky Top */}
      <div className="relative z-20 shrink-0 bg-slate-50/80 backdrop-blur-md border-b border-slate-200/50">
      ...
      <div className="flex-1 overflow-y-auto relative z-10 scroll-smooth">
        <div className="container mx-auto px-4 py-6 md:py-8 text-center max-w-4xl pb-32">
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/50 overflow-hidden text-left">
              <ManualQuizEditor 
                  variant="page"
